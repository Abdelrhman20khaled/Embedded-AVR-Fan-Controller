...
int main(){
	...
	while(1){
		 ...
		 */
			...
			// make a motor rotate CW with speed (25%)
		 ...
		 */
			...
			// make a motor rotate CW with speed (50%)
		 ...
		 */
			...
			// make a motor rotate CW with speed (75%)
		 ...
		 */
			...
			// make a motor rotate CW with it is max speed (100%).
